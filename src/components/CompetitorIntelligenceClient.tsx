                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-1.5 text-[13px] text-zinc-500 mb-4">
                        ...
                        <span>{c.country}</span>
                        <span className="text-zinc-300">·</span>
                        <span>{t('activeCompetitor')}</span>
                      </div>
                      <div className="flex gap-6">
                        <div>
                          <div className="text-[20px] font-extrabold text-blue-600 leading-tight">{(c.total_wins || 0).toLocaleString()}</div>
                          <div className="text-[11px] font-semibold text-zinc-400 uppercase tracking-wider">{t('stats.totalWins')}</div>
                        </div>
                      </div>
                    </div>
                    <div className="flex flex-col items-end gap-2 shrink-0">
                      <Badge color="rose">{t('competitor')}</Badge>
