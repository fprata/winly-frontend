...
export function CompetitorEvolutionCharts({ yearlyStats }: CompetitorEvolutionChartsProps) {
  ...
  if (!yearlyStats || !Array.isArray(yearlyStats) || yearlyStats.length === 0) {
    return <div className="p-8 text-center text-zinc-400 italic">{t('noTrendHistory')}</div>;
  }
    ...
    return (
      <div className="space-y-8 mt-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-white rounded-xl border border-zinc-200/60 shadow-sm p-6 h-[400px] flex items-center justify-center">
  ...
  return (
    <div className="space-y-8 mt-8">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-xl border border-zinc-200/60 shadow-sm p-6 h-[400px] flex flex-col">
