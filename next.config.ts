...
const csp = [
  ...
  `script-src 'self' 'unsafe-inline'${isDev ? " 'unsafe-eval'" : ''} https://*.lemonsqueezy.com https://va.vercel-scripts.com https://us-assets.i.posthog.com https://eu-assets.i.posthog.com`,
